@foreach ($featuredProperties as $featuredProperty)
    <div class="card border-0 property-horizontal--card">
        <a class="card-img card-img--lg" href="{{ route('property.details', @$featuredProperty->slug) }}">
        ...
        <div class="card-body py-md-4 px-md-4">
            <div class="card-body-top mb-4">
                <div class="card-wrapper flex-column">
                    <h4 class="card-title mb-1">
                        <a href="{{ route('property.details', @$featuredProperty->slug) }}">
            ...
            <div class="card-body-middle mb-4">
                <div class="card-progress mb-4">
                    <div class="card-progress__bar">
                        <div class="card-progress__thumb" style="width: {{ @$featuredProperty->invest_progress }}%;">
                        </div>
                    </div>
            ...
            <div class="card-body-bottom">
                <a class="btn btn--sm btn--base" href="{{ route('property.details', @$featuredProperty->slug) }}"
                    role="button">
                    @lang('Details')
                </a>
