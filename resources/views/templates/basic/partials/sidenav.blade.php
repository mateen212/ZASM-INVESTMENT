<div class="sidebar-menu">
    <div class="sidebar-menu__inner">
        ...
        <ul class="sidebar-menu-list">
            ...
            <li class="sidebar-menu-list__item">
                <a href="{{ route('user.deals.mydeals') }}" class="sidebar-menu-list__link {{ menuActive('user.deals*') }}">
                    <span class="icon"><i class="fas fa-dolly-flatbed"></i></span>
                    <span class="text">@lang('Deals')</span>
                </a>
            </li>
            <li class="sidebar-menu-list__item">
                <a href="{{ route('user.dashboards.dashboard2') }}" class="sidebar-menu-list__link {{ menuActive('user.dashboards*') }}">
                    <span class="icon"><i class="fas fa-dolly-flatbed"></i></span>
                    <span class="text">@lang('Deals Dashboard')</span>
                </a>
            </li>
            {{-- <li class="sidebar-menu-list__item">
                <a href="{{ route('user.offerings.offering') }}" class="sidebar-menu-list__link {{ menuActive('user.offerings*') }}">
                    <span class="icon"><i class="fas fa-dolly-flatbed"></i></span>
                    <span class="text">@lang('Offering')</span>
                </a>
            </li> --}}
            <li class="sidebar-menu-list__item">
