            ...
            <div class="card-body px-2 py-3 p-md-3 p-xl-4">
                <div class="card-body-top">
                    <h5 class="card-title mb-2">
                        <a href="{{ route('property.details', @$property->slug) }}">{{ __(@$property->title) }}</a>
                    </h5>
                ...
                <div class="card-body-bottom mb-4">
                    <a class="btn btn--sm btn--base" href="{{ route('property.details', @$property->slug) }}"
...
@empty
    <div class="empty-notification-list text-center">
        <img src="{{ getImage('assets/images/empty_list.png') }}" alt="empty" class="empty-image">
        <h5 class="text-muted">@lang('No property found.')</h5>
    </div>
@endforelse
