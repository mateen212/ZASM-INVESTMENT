...
<body>
    ...
    @php
        ...
        $cookieData = optional($cookie)->data_values ?? null;
        $cookieStatus = optional($cookieData)->status ?? Status::DISABLE;
        $cookieShortDesc = optional($cookieData)->short_desc ?? '';
    @endphp
    @if ($cookieStatus == Status::ENABLE && !\Cookie::get('gdpr_cookie'))
        <div class="cookies-card text-center hide">
            ...
            <p class="mt-4 cookies-card__content">{{ $cookieShortDesc }} <a
