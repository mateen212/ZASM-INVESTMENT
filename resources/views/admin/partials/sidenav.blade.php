@php
    // Use the filtered sidebar links passed from app.blade.php
    // If not provided, fall back to the original behavior
        ...
        <div class="sidebar__menu-wrapper">
            <ul class="sidebar__menu">
                ...
                {{--  <li class="sidebar-menu-list__item">
                    <a href="{{ route('admin.deals') }}" class="sidebar-menu-list__link {{ menuActive('Deal*') }}">
                        <span class="icon"><i class="fas fa-dolly-flatbed"></i></span>
                        <span class="text">@lang('Deals List')</span>
                    </a>
                </li>  --}}
            </ul>
        </div>
