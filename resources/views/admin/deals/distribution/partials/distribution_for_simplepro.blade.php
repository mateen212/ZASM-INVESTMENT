...
<div class="container mt-5">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" x-on:input="moneyFormat($el)" class="form-control" id="distribution_amount" x-model="distributionForm.amount">
    </div>
    <div class="form-group mb-3">
    ...
    <div class="form-group mb-3">
        ...
        <input type="date" onclick="this.showPicker()" class="form-control" x-on:input="distributionErrors.start_date =''" id="period_start_date" x-model="distributionForm.start_date">
    ...
    <div class="form-group mb-3">
        ...
        <input type="date" onclick="this.showPicker()" class="form-control" x-on:input="distributionErrors.end_date =''" id="period_end_date" x-model="distributionForm.end_date">
    ...
    <div class="form-group mb-3">
        ...
        <input type="date" onclick="this.showPicker()" class="form-control" x-on:input="distributionErrors.distribution_date =''" id="distribution_date" x-model="distributionForm.distribution_date">
