<template x-if="distributionForm.calculation_method === 'Custom'">
    <div id="distributionDetails" class="step-content" >
        <div class="container mt-5">
            
            @csrf
            <!-- Distribution Source -->
            {{--  <div class="form-group mb-3 h-20">
            <label for="import_distribution">Import custom distribution amounts <span class="text-danger">*</span></label>
                <select id="import_distribution" name="import_distribution" class="form-control">
