<div class="container mt-5">
    ...
    <div class="form-group mb-3">
        ...
        <select class="form-control" id="compounding_period" x-on:input="distributionErrors.compounding_period =''" name="compounding_period" x-model="distributionForm.compounding_period">
