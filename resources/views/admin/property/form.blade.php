            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs mb-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if ($step == 3) active @endif @if(!@$property) disabled @endif"
                                href="{{ @$property ? route('admin.manage.property.edit', $property->id) . '?step=3' : 'javvascript:void(0)' }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if ($step == 4) active @endif"
                                href="{{ @$property ? route('admin.manage.property.edit', $property->id) . '?step=4' : route('admin.manage.property.create') }}">
