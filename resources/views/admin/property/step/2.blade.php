        ...
        <div class="row">
            ...
            <div class="col-md-6 profit-distribution-amount-wrapper d-none">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" step="any" class="form-control" name="auto_profit_distribution_amount"
                            value="{{ old('auto_profit_distribution_amount', getAmount(@$property->auto_profit_distribution_amount ?? 0)) }}" />
                        <span class="input-group-text profit--amount-type">@lang('%')</span>
                    </div>
                </div>
            </div>
