...
class SiteController extends Controller
{
    public function index()
    {
        ...
        $seoContents = optional($sections)->seo_content;
        $seoImage = optional($seoContents)->image ? getImage(getFilePath('seo') . '/' . optional($seoContents)->image, getFileSize('seo')) : null;
    ...
    public function pages($slug)
    {
        ...
        $pageTitle = $page->name;
        $sections = $page->secs;
        $seoContents = optional($page)->seo_content;
        $seoImage = optional($seoContents)->image ? getImage(getFilePath('seo') . '/' . optional($seoContents)->image, getFileSize('seo')) : null;
    ...
    public function blogDetails($slug)
    {
        ...
        $seoContents = optional($blog)->seo_content;
        $seoImage = optional($seoContents)->image ? frontendImage('blog', optional($seoContents)->image, getFileSize('seo'), true) : null;
    ...
    public function deals()
    {
        ...
        return view('Template::exploreDeals', compact('offerings', 'pageTitle'));
    }
    ...
    public function offering($offering)
    {
        ...
        if (!$offering) {
            return redirect()->route('deals')->with('error', 'Offering not found');
        }
        ...
        return view('Template::publicOfferings', compact(
            'offering',
            'pageTitle',
            'investor'
        ));
    ...
    public function propertyDetails($slug)
    {
        ...
        $seoContents = optional($property)->seo_content;
        $seoImage = optional($seoContents)->image ? getImage(getFilePath('seo') . '/' . optional($seoContents)->image, getFileSize('seo')) : null;
